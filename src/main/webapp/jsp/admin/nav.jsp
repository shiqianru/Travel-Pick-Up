    	...
    	<div class="sidebar">
            ...
            <ul class="nav">
                ...
                <li class="nav-li current">
                	...
                	<ul class="subnav">
                    	<li class="subnav-li current" href="jsp/admin/index.jsp" data-id="1"><a href="javascript:;" class="ue-clear"><i class="subnav-icon"></i><span class="subnav-text">首页</span></a></li>
                        <li class="subnav-li" href="jsp/admin/form.jsp" data-id="2"><a href="javascript:;" class="ue-clear"><i class="subnav-icon"></i><span class="subnav-text">表单</span></a></li>
                        <li class="subnav-li" href="jsp/admin/table.jsp" data-id="3"><a href="javascript:;" class="ue-clear"><i class="subnav-icon"></i><span class="subnav-text">表格</span></a></li>
