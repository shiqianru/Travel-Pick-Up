...
<link rel="stylesheet" type="text/css" href="admin/css/skin_/main.css" />
<link rel="stylesheet" type="text/css" href="admin/css/jquery.dialog.css" />
...
<div id="container">
    ...
    <div id="bd">
        <iframe width="100%" height="100%" id="mainIframe" src="jsp/admin/nav.jsp" frameborder="0"></iframe>
    </div>
...
<script type="text/javascript" src="admin/js/jquery.dialog.js"></script>
<script type="text/javascript">
