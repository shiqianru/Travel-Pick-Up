            ...
            <div class="container">
                <div class="row justify-content-center align-items-center d-flex">
                    <div class="col-lg-8">
                        ...
                        <s:if test="#session.resultCount!=null">
                        	<p class="mt-20 text-center text-white">根据“${session.searchContent }” 查询到 ${session.resultCount } 条记录 </p>
                        </s:if>
                    </div>
                </div>
            </div>  
            ...
            <div class="row justify-content-center d-flex">
                <div class="col-lg-8">
                    <div class="post-lists search-list">
	                    <s:iterator value="#session.cList" var="city">
	                    	<div class="single-list flex-row d-flex" style="width: 700px;height: 250px;"><!-- 一个单元 -->
	                            ...
	                            <div class="detail" style="width: 70%;height: 100%;padding-bottom: 20px;">
	                            	<div style="width: 100%;height: 20%;">
	                               		<a href="attractions/getCityDetail.action?id=${city.id }"><h4 class="pb-20">${city.cityName }</h4></a>
	                                </div>
	                    ...
	                    <s:iterator value="#session.attrList" var="attr">
	                    	<div class="single-list flex-row d-flex" style="width: 700px;height: 250px;"><!-- 一个单元 -->
	                            ...
	                            <div class="detail" style="width: 70%;height: 100%;padding-bottom: 20px;">
	                            	<div style="width: 100%;height: 20%;">
	                               		<a href="attractions/getAttrDetail.action?viewTitle=${attr.viewTitle }"><h4 class="pb-20">${attr.viewTitle }</h4></a>
	                                </div>
	                                <div style="width: 100%;height:50%;">
	                                	<p class="viewDiscrib">
		                                     ${attr.viewDiscrib}
