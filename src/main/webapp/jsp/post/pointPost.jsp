            ...
            <div class="row justify-content-center d-flex">
                <div class="col-lg-8">
                    <div class="post-lists">
	                    <s:if test="#session.pointPost!=null && !#session.pointPost.isEmpty()">
	                    	<s:iterator value="#session.pointPost" var="post">
	                    ...
	                    <s:else><span>还没有相关帖子哦！</span></s:else>
                    </div>
