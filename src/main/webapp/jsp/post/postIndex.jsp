                ...
                <div class="row justify-content-between align-items-center d-flex">
                    <div class="col-lg-8 top-left">
                        ...
                        <ul>
                            ...
                            <li><a href="post/square.action">全部</a></li>
                        </ul>
                    </div>
                </div>
            </div>  
    ...
    <section class="post-area">
        <div class="container">
            <div class="row justify-content-center d-flex">
                <div class="col-lg-8">
                    <div style="font-size: 20px;font-weight: bold;float: left;">热&nbsp;&nbsp;门</div>
                    <div style="float: left;"><img alt="" src="image/hot.gif"></div>
                    <div class="top-posts pt-50">
                        <div class="container">
                            <div class="row justify-content-center">
                            	<s:iterator value="#session.squareHotPost" var="hotPost">
                            		<div class="single-posts col-lg-6 col-sm-6">
	                                    <s:if test="#hotPost.homePageImgUrlVO != null">
	                                   		 <img height="150px" src="upload/${hotPost.homePageImgUrlVO.imageUrl }" alt="">
	                                    </s:if>
	                                    <s:else>
	                                    	 <img height="150px" src="image/hpalt.png" alt="">
	                                    </s:else>
	                                    <div class="date mt-20 mb-20"><span class="postTime">${hotPost.postTime }</span></div>
	                                    <div class="detail">
	                                        <a href="post/getPostDetail.action?postId=${hotPost.id }"><h4 class="pb-20">${hotPost.postName }</h4></a>
	                                        <p>
	                                            ${hotPost.postContent }
	                                        </p>
	                                        <p class="footer pt-20">
	                                        <i class="fa fa-heart-o" aria-hidden="true"></i>
	                                        <a href="#">${hotPost.likeCount } 赞</a>     <i class="ml-20 fa fa-comment-o" aria-hidden="true"></i> <a href="#">${hotPost.commentCount } 评论</a>
	                                        </p>
	                                    </div>
	                                </div>
                            	</s:iterator>                                                                       
                    ...
                    <div class="post-lists">
                    	<s:iterator value="#session.squareNewestPost" var="post">
