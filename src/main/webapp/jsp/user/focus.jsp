                    ...
                    <div class="row justify-content-start align-items-center d-flex">
                        <div class="col-lg-8 top-left">
                            ...
                            <ul>
                                ...
                                <li><a href="post/getAllPost.action">关注</a></li>
                            </ul>
                        </div>
                    </div>
                </div>  
                ...
                <div class="row justify-content-center d-flex">
                    <div class="col-lg-8">
                        <div class="post-lists search-list">
                        	<s:if test="#session.focusUserList!=null && !#session.focusUserList.isEmpty()">
                        		<s:iterator value="#session.focusUserList" var="user">
