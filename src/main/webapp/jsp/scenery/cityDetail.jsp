...
.banner ul li { float: left; }
		...
		<div class="main-wrapper">
			...
			<div class="banner" id="b04" style="margin: 0 auto;">
				<ul>
			       	<li><img src="image/bj.jpg" alt=""  height="300"></li>
			    </ul>
			</div>
			...
			<section class="about-generic-area pb-100">
				<div class="container border-top-generic" style="margin-top: 50px;">
					<h3 class="about-title mb-30">${session.cityDetail.cityName }</h3>
					<div class="row">
						<div class="col-lg-12" style="margin-top: 30px;">
							<span>简介：</span>
							<div  class="img-text">${session.cityDetail.cityDiscrib }</div>
						</div>
						<div class="col-lg-12" style="margin-top: 30px;">
							${session.cityDetail.cityRaiders }
						</div>
						<div class="col-lg-12" style="margin-top: 30px;">
							<span style="color:#000;"><b>推荐：</b></span>
							<s:iterator value="#session.attrOfCity" var="attr">
								<a href="attractions/getAttrDetail.action?viewTitle=${attr.viewTitle }">${attr.viewTitle}</a>
							</s:iterator>
						</div>
					</div>
				</div>
